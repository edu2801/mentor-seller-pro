...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="flex justify-end">
            <a :href="`https://sellercentral.amazon.com.br/apps/authorize/consent?application_id=amzn1.sp.solution.dd1ba476-2cc9-4aae-ba79-629aabcf8f79&state=${state}&version=beta`" class="flex items-center justify-center px-4 py-2 mt-4 mr-15 text-sm font-medium text-white bg-orange-600 rounded-md hover:bg-orange-700">
                Adicionar Conta
            </a>
        </div>
